...
select first_name, last_name, gender from employees.employees where first_name = 'Irena' or first_name = 'Vidya' or first_name = 'Maya' and gender
= 'M' order by last_name, first_name;
